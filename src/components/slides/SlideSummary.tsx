    ...
    <SlideContainer>
      <div className="flex justify-between items-end mb-12 border-b border-slate-100 pb-6">
        ...
        <div className="text-right">
          <p className="text-slate-500 text-sm">Plano Estratégico 2026</p>
          <p className="text-slate-900 font-semibold">{proposal.clientName}</p>
        </div>
      </div>

      <div className="grid grid-cols-12 gap-12 h-full">
        <div className="col-span-4 bg-slate-50 rounded-2xl p-8 border border-slate-100 h-fit">
          <h3 className="text-xl font-bold text-slate-900 mb-6 flex items-center gap-2">
            <Users className="w-5 h-5 text-sky-500" /> O Cliente
          </h3>
        ...
        <div className="col-span-8 flex flex-col justify-between">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 text-sm mt-1">
                      Conquistar posicionamento de liderança e maximizar o
                      retorno sobre investimento (ROI) através de canais de alta
                      performance.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-slate-200 p-6 rounded-xl shadow-sm">
              ...
              <p className="text-3xl font-bold text-slate-900">Liderança</p>
              <p className="text-slate-500 text-sm font-medium">Market Share</p>
            </div>
          </div>
        </div>
      </div>
